...
import 'package:esptouch_example/shared/animations.dart';
import 'package:esptouch_example/widgets/room_background_image.dart';
import 'package:esptouch_example/widgets/room_heading.dart';
import 'package:esptouch_example/widgets/room_details/device.dart';
import 'package:esptouch_example/widgets/room_details/music_player.dart';
import 'package:esptouch_example/widgets/room_details/device_controller.dart';
import 'package:esptouch_example/widgets/room_details/air_conditioner_controller.dart';
import 'package:esptouch_example/widgets/room_details/shutter_controler.dart';
...
class _RoomDetailsPageState extends State<RoomDetailsPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildShutter() {
    return Transform.translate(
      offset: Offset(_enterAnimations.shutterTranslation.value, 0.0),
      child: const Shutter(
        status: true,
        heading: 'Shutter',
      ),
