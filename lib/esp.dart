...
const helperSSID =
    "The technical term for a network name.";
const helperBSSID =
    "The MAC address of the wireless access point (router).";
const helperPassword = "The password of the Wi-Fi network";

class _MyAppState extends State<ESP> {
...
class TaskRouteState extends State<TaskRoute> {
  ...
  void initState() {
    ...
    _streamSubscription = _stream.listen((value) {
      // TODO: Don't use StreamBuilder and listen in the same example
          ...
          child: Row(
            ...
            children: <Widget>[
              GestureDetector(
                ...
                child: Row(
                  children: <Widget>[
                    Text('BSSID: ', style: Theme.of(context).textTheme.bodyText2),
                    Text(result.bssid,
